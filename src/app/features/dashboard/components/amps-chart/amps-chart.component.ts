...
import { AmpsChartDataPoint } from '../../../../shared/models/dashboard.model';
...
export class AmpsChartComponent implements OnInit, OnChanges, OnDestroy {
  @Input() data: AmpsChartDataPoint[] = [];
